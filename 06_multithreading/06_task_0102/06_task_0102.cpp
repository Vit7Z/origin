...
int main() {
 ...
 //таблица времени выполнения
	array <string, 5> row_1{ "2 потока", "0", "0", "0", "0" };
	array <string, 5> row_2{ "4 потока", "0", "0", "0", "0" };
	array <string, 5> row_3{ "8 потоков", "0", "0", "0", "0" };
	array <string, 5> row_4{ "16 потоков", "0", "0", "0", "0" };
